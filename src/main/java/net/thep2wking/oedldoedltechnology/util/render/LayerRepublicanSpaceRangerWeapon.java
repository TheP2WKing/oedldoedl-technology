...
public class LayerRepublicanSpaceRangerWeapon implements LayerRenderer<EntityLivingBase> {
	protected final RenderLivingBase<?> livingEntityRenderer;

	public LayerRepublicanSpaceRangerWeapon(RenderLivingBase<?> livingEntityRendererIn) {
	...
	public void renderHeldItem(EntityLivingBase p_188358_1_, ItemStack p_188358_2_,
