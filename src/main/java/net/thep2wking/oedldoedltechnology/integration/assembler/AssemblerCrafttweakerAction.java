...
abstract class AssemblerCrafttweakerAction implements IAction {
	final ItemStack output1;
	final ItemStack input1;
	final ItemStack input2;
	final int time;

	public AssemblerCrafttweakerAction(ItemStack output1, ItemStack input1, ItemStack input2, int time) {
	...
	public AssemblerCrafttweakerAction(IItemStack output1, IItemStack input1, IItemStack input2, int time) {
		this(CraftTweakerMC.getItemStack(output1), CraftTweakerMC.getItemStack(input1),
				CraftTweakerMC.getItemStack(input2), time);
	}

	static class Add extends AssemblerCrafttweakerAction {
	...
	static class Remove extends AssemblerCrafttweakerAction {
