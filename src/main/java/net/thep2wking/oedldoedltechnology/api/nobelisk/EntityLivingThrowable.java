...
public class EntityLivingThrowable extends EntityLiving implements IProjectile {
	...
	public EntityLivingThrowable(World world) {
		super(world);
	}

	public EntityLivingThrowable(World world, EntityLivingBase thrower) {
		this(world);
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(0.25d);
	}
