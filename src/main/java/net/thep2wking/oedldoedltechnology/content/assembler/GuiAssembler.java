...
public class GuiAssembler extends GuiFactoryBase {
	public GuiAssembler(InventoryPlayer inventoryPlayer, TileFactoryBase tileEntity) {
		super(new ContainerAssembler(inventoryPlayer, tileEntity), inventoryPlayer, tileEntity);
	}
