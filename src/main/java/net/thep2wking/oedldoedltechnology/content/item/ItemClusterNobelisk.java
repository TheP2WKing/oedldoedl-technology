...
public class ItemClusterNobelisk extends ModItemNobeliskBase {
	public ItemClusterNobelisk(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ModEntityNobeliskBase setNobeliskEntity(World world, EntityPlayer player) {
		return new EntityClusterNobelisk(world, player);
	}
}