...
public class ItemSomersloop extends ModItemBase {
    public ItemSomersloop(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        if (ModTooltips.showAnnotationTip()) {
            tooltip.add(CoreConfig.TOOLTIPS.COLORS.INFORMATION_ANNOTATION_FORMATTING.getColor()
                    + I18n.format(this.getUnlocalizedName() + ".annotation1") + TextFormatting.YELLOW + " x"
