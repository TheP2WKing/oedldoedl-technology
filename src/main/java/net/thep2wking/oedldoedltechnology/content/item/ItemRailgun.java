...
public class ItemRailgun extends ModItemEnergyWeaponBase {
	public ItemRailgun(String modid, String name, CreativeTabs tab, int range, int cooldown, int damage,
		...
		super(modid, name, tab, range, cooldown, damage, explosionDamage, maxUseTime, shotSpeed, zoom, maxHeat,
	...
	public void onClientShot(ItemStack weapon, EntityLivingBase shooter, Vec3d position, Vec3d dir, WeaponShot shot) {
		MOPositionedSound sound = new MOPositionedSound(ModSounds.RAILGUN_SHOT, SoundCategory.PLAYERS,
